        ...
        <div class="col-lg-5">
            ...
            <div class="form-wrap border rounded p-4">
                ...
                <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
                    <div class="mb-3">
                        <label for="user_login" class="form-label">Email of gebruikersnaam</label>
                    ...
                    <div class="mb-3 form-check">
                        ...
                        <label for="togglePassword" class="form-check-label">Laat wachtwoord zien</label>
                    </div>
                    <div class="mb-3">
